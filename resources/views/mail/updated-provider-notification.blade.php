...
<tr>
   <td style="position: relative; float: left; width: 100%; margin:0px 0px 0px 0px; padding: 20px 0px 0px 0px; text-align: left; background: #ffffff;color: #333333;">
      ...
      <h2 style="width: 100%; margin: 0px; padding: 10px 0px 0px 0px; font-family: Lato, sans-serif; font-size: 16px; text-align: left; color: #333333;">Provider has been updated.</h2>
...
<tr>
   <td style="position: relative; float: left; width: 100%; margin:0px 0px 0px 0px; padding: 0px 0px 25px 0px; text-align: left; background: #ffffff;">
      ...
      <div style="text-align: center;">
         <h4><a href="{{route('admin.view.changes', ['user_id'=> $data['user_id']])}}" class="btn" style="margin-right: 20px;">View Details</a>
         <a href="{{ route('profile.updated.approve', ['token'=>$data['token']])}}" class="btn">Approve</a></h4>
      </div>
   </td>
</tr>
