...
<tr>
   <td style="position: relative; float: left; width: 100%; margin:0px 0px 0px 0px; padding: 20px 0px 0px 0px; text-align: left; background: #ffffff;color: #333333;">
      ...
      @else
         Hello!
      @endif</h1>
      <h2 style="width: 100%; margin: 0px; padding: 10px 0px 0px 0px; font-family: Lato, sans-serif; font-size: 16px; text-align: left; color: #333333;">Thank you for your interest in The Parents Care!</h2>
   </td>
</tr>
<tr>
   <td style="position: relative; float: left; width: 100%; margin:0px 0px 0px 0px; padding: 0px 0px 25px 0px; text-align: left; background: #ffffff;">
      <div style="text-align: left;">
         <p style="margin-top: 10px;margin-bottom: 20px;">
            You are receiving this email because we received your new account request.
         </p>
         <p>
            Your verification code is: <span style="font-weight: bold;font-size: 15px;">{{ $data['code'] }}</span>
         </p>
      </div>
   </td>
</tr>
