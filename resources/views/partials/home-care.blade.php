...
<div class="row">
    ...
    <div class="col-lg-6 col-xs-12 register-form-input">
        <textarea  row="5" class="form-control @error('address') is-invalid @enderror" name="address" value="{{ old('address') }}" placeholder="{{ trans('auth.address') }} *"></textarea>
    </div>
</div>
<div class="form-group row">
...
<div class="form-group row">
    <div class="col-xs-12 col-lg-6 register-form-input">
        <textarea row="5" class="form-control @error('service_provider') is-invalid @enderror" name="service_provider" placeholder="{{ trans('messages.service_provider') }}">{{ old('service_provider') }}</textarea>
    </div>
    <div class="col-xs-12 col-lg-6 register-form-input">
...
<div class="row">
    ...
    <div class="col-lg-6 col-xs-12 register-form-input">
        <label for="care_home_photo" class="custom-file-upload care_home_photo"> {{ trans('messages.photo') }}</label>
...
<div class="form-group row">
    <div class="col-lg-9 col-xs-12 images_preview_care_home_photo"></div>
