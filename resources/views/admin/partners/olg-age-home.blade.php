...
<div class="row">
    <div class="col-lg-6 col-xs-12">
        <div class="form-group">
            ...
            <input  type="text" class="form-control @error('name') is-invalid @enderror" name="name" value="{{ old('name') }}"  placeholder="{{ trans('auth.home_name') }}">
        </div>
    </div>
    <div class="col-lg-6 col-xs-12">
        <div class="form-group">
            ...
            <select  class="form-control @error('govt_approved') is-invalid @enderror" name="govt_approved">
                @foreach($govtApproved as $key=>$value)
                    <option value="{{ $key }}" @if(old('govt_approved') == $key) selected="selected" @endif> {{ $value }} </option>
                @endforeach
            </select>
    ...
    <div class="col-lg-6 col-xs-12">
        <div class="form-group">
            ...
            <input type="text" class="form-control @error('number_of_rooms') is-invalid @enderror" name="number_of_rooms" value="{{ old('number_of_rooms') }}" placeholder="{{ trans('auth.number_of_rooms') }}">
        </div>
    </div>
    <div class="col-lg-6 col-xs-12">
        <div class="form-group">
    ...
    <div class="col-lg-6 col-xs-12">
        <div class="form-group">
            ...
            <input  type="text" class="form-control @error('room_rent') is-invalid @enderror" name="room_rent" value="{{ old('room_rent') }}"  placeholder="{{ trans('messages.room_rent').' '.trans('messages.room_rent_rate') }}">
        </div>
    </div>
    <div class="col-lg-6 col-xs-12">
        <div class="form-group">
            <label>{{ trans('auth.other_facilities_available') }}</label>
            <textarea type="text" class="form-control @error('other_facilities_available') is-invalid @enderror" name="other_facilities_available" value="{{ old('other_facilities_available') }}" placeholder="{{ trans('auth.other_facilities_available') }}"></textarea>
        </div>
    </div>
    <div class="col-lg-6 col-xs-12">
        <div class="form-group">
