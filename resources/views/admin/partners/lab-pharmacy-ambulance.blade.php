...
<div class="row">
    ...
    <div class="col-lg-6 col-xs-12">
        <div class="form-group">
            ...
            <textarea row="5" class="form-control @error('list_of_tests_provided') is-invalid @enderror" name="list_of_provided" placeholder="{{ trans('messages.list_of_tests_provided') }}"></textarea>
        </div>
    </div>
    <div class="col-lg-6 col-xs-12">
        <div class="form-group">
            <label>{{ trans('auth.address') }}</label>
            <textarea  row="5" class="form-control @error('address') is-invalid @enderror" name="lab_address" placeholder="{{ trans('auth.address') }} "></textarea>
        </div>
    </div>
