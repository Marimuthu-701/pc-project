...
<div class="row">
    ...
    <div class="col-lg-6 col-xs-12">
        <div class="form-group">
            <label>{{ trans('messages.list_of_tests_provided') }}</label>
            <textarea row="5" class="form-control @error('list_of_tests_provided') is-invalid @enderror" name="list_of_provided" placeholder="{{ trans('messages.list_of_tests_provided') }}">{{ isset($serviceInfo->tests_provided) ? $serviceInfo->tests_provided : null}}</textarea>
        </div>
    </div>
    <div class="col-lg-6 col-xs-12">
        <div class="form-group">
            <label>{{ trans('auth.address') }}</label>
            <textarea  row="5" class="form-control @error('address') is-invalid @enderror" name="lab_address" placeholder="{{ trans('auth.address') }} ">{{ isset($serviceInfo->address) ? $serviceInfo->address : null}}</textarea>
        </div>
    </div>
    ...
    <div class="col-lg-6 col-xs-12">
        <div class="form-group">
            ...
            <textarea row="5" class="form-control @error('add_info') is-invalid @enderror" name="add_info"  placeholder="{{ trans('auth.any_additional_info') }}">{{ isset($serviceInfo->name) ? $serviceInfo->name : null}}</textarea>
        </div>
    </div>
    <div class="col-lg-6 col-xs-12">
        <div class="form-group">
            ...
            <input type="hidden" name="lab_pharmacy_img" value="{{ isset($serviceMedia[0]['file']) ? $serviceMedia[0]['file'] : null }}" id="lab_pharmacy_img">
        </div>
