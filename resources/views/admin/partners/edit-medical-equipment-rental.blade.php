...
<div class="row">
    ...
    <div class="col-lg-6 col-xs-12">
        <div class="form-group">
            ...
            <textarea  row="5" class="form-control @error('address') is-invalid @enderror" name="medical_address" placeholder="{{ trans('auth.address') }}">{{ isset($serviceInfo->address) ? $serviceInfo->address : old('medical_address') }}</textarea>
        </div>
    </div>
    ...
    <div class="col-lg-6 col-xs-12">
        <div class="form-group">
            ...
            <input type="hidden" name="medical_img" value="{{ isset($serviceMedia[0]['file']) ? $serviceMedia[0]['file'] : null }}" id="medical_img">
