...
<div class="row">
    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 profile_container">
        <div class="card">
            ...
            <form action="{{ route('admin.services.store') }}" method="post" class="services" enctype="multipart/form-data">
                {{ csrf_field() }}
                <div class="card-body">
                    <div class="row">
                        <div class="col-lg-10">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control {{ $errors->has('name') ? 'is-invalid' : '' }}" id="first_name" tabindex="1" name="name" placeholder="{{ trans('auth.service_name_placeholder') }}" @if($errors->has('name')) value="{{ old('name') }}" @endif>
                                        @if($errors->has('name'))
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea id="description" row="5" tabindex="2" class="form-control @error('description') is-invalid @enderror" name="description" placeholder="{{trans('auth.description')}}"></textarea>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <label for="featured">{{ trans('auth.feature') }}</label>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control {{ $errors->has('position') ? 'is-invalid' : '' }}" id="position" tabindex="5" name="position" placeholder="{{ trans('auth.position') }}" value="{{ old('position') }}">
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <select class="form-control {{ $errors->has('form_set') ? 'is-invalid' : '' }}" id="form_set" tabindex="5" name="form_set">
                                            ...
                                            @foreach($formset as $key => $value)
                                                <option value="{{ $key }}" @if(old('form_set') == $key) selected="selected" @endif>{{ $value }}</option>
                                            @endforeach
                                        </select>
