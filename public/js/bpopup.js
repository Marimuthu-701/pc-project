    ...
    $.fn.bPopup = function(options, callback) {
		...
		function open(){
            ...
            $popup
				...
				.css({ 
					  'right': o.transition == 'slideIn' || o.transition == 'slideBack' ? (o.transition == 'slideBack' ? d.scrollLeft() + wW : (hPos + width) *-1) : getLeftPos(!(!o.follow[0] && fixedHPos || fixedPosStyle))
		...
		function recenter(content){
			...
			css.right = getLeftPos(!(!o.follow[0] && fixedHPos || fixedPosStyle)),
